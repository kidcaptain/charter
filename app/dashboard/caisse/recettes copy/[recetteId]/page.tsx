    ...
    return (
        <div className=" w-full p-10">
            <div className=" py-2 flex justify-between items-start">
                <h1 className="lowercase text-sm  text-gray-900"><Link className="hover:text-blue-600" href={"/dashboard/caisse/recettes"}>recettes</Link> / <Link className="hover:text-blue-600" href="#">Fiche n°{params.recetteId}</Link></h1>
            </div>
            <div>
