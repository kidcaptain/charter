    ...
    return (
        <div className=" w-full p-10">
            <div className=" py-4 flex lowercase text-sm justify-between items-start mb-2">
                <h1 className=" text-gray-900"><Link className="hover:text-blue-600" href={"/dashboard/directeur/voyages"}>Voyages</Link> / <Link className="hover:text-blue-600" href="#">Editer</Link></h1>
            </div>
