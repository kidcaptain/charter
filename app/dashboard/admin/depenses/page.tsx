        ...
        <div className="p-10">
            ...
            <div className="grid grid-cols-4 gap-4  items-start">
                ...
                <div className="p-4 col-span-full">
                    <Link href="/dashboard/admin/depenses/hebdomadaires" className="text-stone-800 border bg-gray-100 hover:bg-gray-300 text-sm p-2 rounded-sm">Fiches de dépenses hebdomadaires</Link>
                    <Link href="/dashboard/admin/depenses/Journalieres" className="text-stone-800 border bg-gray-100 hover:bg-gray-300 text-sm p-2 rounded-sm">Fiches de dépenses Journalières</Link>
                    <button type="button" onClick={getDepense} className="text-stone-800 border bg-blue-400 hover:bg-blue-500 text-sm p-2 rounded-sm">Actualiser</button>
                </div>
