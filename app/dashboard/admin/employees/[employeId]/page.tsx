    ...
    return (
        <div className="p-10 ">
               <div className=" py-2 flex justify-between items-start">
                <h1 className="lowercase text-sm  text-gray-900"><Link className="hover:text-blue-600" href={"/dashboard/admin/employees"}>Employés</Link> / <Link className="hover:text-blue-600" href="#">Informations personnelles</Link></h1>
            </div>
            <div className="  ">
                <h2 className="p-4 bg-white uppercase border-b">
                    Informations Personnelles
                </h2>
                <ModalFiche isAdmin="admin" id={params.employeId} />
            </div>
