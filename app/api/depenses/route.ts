...
export const GET = async (req: NextRequest) => {
    ...
    try {
        if(idTypeDepense && typeDepense1 && typeDepense && typeDepense2 && typeDepense3 && typeDepense4) {
            const depenses = await prisma.depense.findMany({ where: { AND :[{ idTypeDepense: idTypeDepense, typeDepense: typeDepense}, { idTypeDepense: idTypeDepense, typeDepense: typeDepense2}, { idTypeDepense: idTypeDepense, typeDepense: typeDepense3}, { idTypeDepense: idTypeDepense, typeDepense: typeDepense4}, { idTypeDepense: idTypeDepense, typeDepense: typeDepense1} ]} });{}
